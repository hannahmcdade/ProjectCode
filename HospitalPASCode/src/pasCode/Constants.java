...
public class Constants {
	 ...
	 */
	public final static int REFRESHTIME = 30000;
	...
	/**
	 * Constant to hold the database query to access the staff details within
	 * the database
	 */
	public static final String DATABASE_STAFF_SELECT_QUERY = "select * from STAFF";

	/**
	 * Constant to hold the database query to access the doctor on call
	 * telephone number
	 */
	public static final String DATABASE_FIRSTDOCTORTELEPHONE_SELECT_QUERY = "select telephone from STAFF where staff_id=1005";

	/**
	 * Constant to hold the database query to access the nurse on call telephone
	 * number
	 */
	...
	/**
	 * Constant containing the STAFF_FIRST_NAME key to be accessed in the
	 * database
	 */
	public static final String DATABASE_STAFF_FIRST_NAME = "FIRST_NAME";

	/**
	 * Constant containing the STAFF_LAST_NAME key to be accessed in the
	 * database
	 */
	...
	/**
	 * Constant containing the STAFF_TELEPHONE key to be accessed in the
	 * database
	 */
